...
const Admin = () => {
  ...
  <div className="p-4 xl:ml-80">
          ...
          <nav aria-label="breadcrumb" className="w-max">
            <ol className="flex flex-wrap items-center w-full bg-opacity-60 rounded-md bg-transparent p-0 transition-all">
              <li className="flex items-center text-blue-gray-900 antialiased font-sans text-sm font-normal leading-normal cursor-pointer transition-colors duration-300 hover:text-light-blue-500">
                <a href="#">
                  <p className="text-black block antialiased font-sans text-sm leading-normal text-blue-900 font-normal opacity-50 transition-all hover:text-blue-500 hover:opacity-100">dashboard</p>
                </a>
              ...
              <li className="flex items-center text-blue-900 antialiased font-sans text-sm font-normal leading-normal cursor-pointer transition-colors duration-300 hover:text-blue-500">
                <p className="text-black block antialiased font-sans text-sm leading-normal text-blue-gray-900 font-normal">home</p>
              </li>
            </ol>
          </nav>
    ...
    <div className="mt-12">
      ...
      <div className="flex m-8 border-[1px] p-8">
        <button  onClick={() => {setModalOpen(true)}} className="w-29 h-14 bg-red rounded-[10px] flex justify-center items-center text-white p-2">Добавить товар</button>
      </div>
  ...
  <BasicModal
        isOpen={isModalOpen}
        onCloseModal={onTogleModal}
      >
        <AddProduct onCloseModal={onTogleModal} />
      </BasicModal>
      </div>
  )
}
