...
const Product = () => {
  ...
  <div className="flex flex-row h-10 w-full rounded-lg relative bg-transparent mt-1">
    ...
    <input type="number" className="outline-none pointer-events-none focus:outline-none text-center w-full bg-gray-300 font-semibold text-md hover:text-black focus:text-black  md:text-basecursor-default flex items-center text-gray-700  outline-none" name="custom-input-number" value={count}></input>
  <button onClick={(e) => {
    e.preventDefault()
    setCount(count+1)
